...
const __demoCatalog: ProductDto[] = [
  ...
  {
    id: 7, slug: 'shivhari-dev-template',
    title: 'Cinematic Portfolio Template',
    tagline: 'The exact site you\'re on — scroll-driven cinema, R3F 3D scenes, store + admin included.',
    description: 'Drop in your name, your projects, your frame sequence, your colours. Designed to brand-customize in under 30 minutes. React + Vite + R3F + Framer Motion + GSAP frontend, Spring Boot backend with store + admin.',
    category: 'Templates',
    priceInr: 3999, priceUsd: 49,
    coverColor: '#60a5fa',
    ...
    techStack: ['React 18', 'Vite', 'TypeScript', 'Tailwind', 'R3F', 'Framer Motion', 'Spring Boot'],
    featured: true,
  },
  {
    id: 8, slug: 'cafe-pos',
