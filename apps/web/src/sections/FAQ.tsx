...
export const faqDefaults: FaqItem[] = [
  ...
  { q: 'Is Shivhari available as a forward deployed engineer or for freelance engagements?',
    a: 'Yes. He takes per-customer engagements and retainers as a forward deployed engineer, Workiva expert or Scrum Master, with an NDA and clean IP on every engagement. The first step is a free 30-minute discovery call; he replies within 24 hours.' },
