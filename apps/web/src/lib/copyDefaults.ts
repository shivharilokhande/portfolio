...
export const copyDefaults: CopyDoc = {
  ...
  contact: {
    ...
    fields: {
      ...
      projectTypePlaceholder: 'e.g. forward deployed engineer, Workiva integration, Spring Boot rescue',
  ...
  footer: {
    ...
    contactCardBody:    'Forward-deployed & Workiva engagements open. Six-week pilot or three-month retainer.',
